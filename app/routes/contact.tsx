...
export const action: ActionFunction = async ({ request }) => {
  ...
  if (Object.values(fieldErrors).some(Boolean)) {
    return json(
      { fieldErrors, fields: { name, email, message } },
      { status: 400 }
    )
  }
...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-6 overflow-y-auto">
      <div className="max-w-4xl w-full bg-white shadow-md rounded-lg overflow-hidden">
        <div className="md:flex">
          ...
          <div className="w-full md:w-1/2 p-8 bg-blue-600 text-white">
            ...
            <p className="mb-6">
              At Comet Park, we strive to provide the best parking solutions for
              our community. Whether you're a student, faculty member, or
              visitor, our services are tailored to meet your parking needs
              efficiently and conveniently.
            </p>
            <p className="mb-4">
              Our state-of-the-art facilities ensure that your vehicle is safe
              and secure. With ample parking spaces, easy access, and
              competitive pricing, parking has never been easier.
            </p>
            <p>
              Explore our website to learn more about our services, find the
              perfect parking spot, and get in touch with our team for any
